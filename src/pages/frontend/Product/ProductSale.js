...
const ProductSale = () => {
  ...
  return (
        <section className="product_sale" style={{ backgroundColor: "#ffffe1ff" }}>
            <div className="container">
              <div className="row">
                  ...
                  <Link to="/tat-ca-san-pham" className="btn btn-outline-info">Xem tất cả sản phẩm</Link>
                  </div>
              </div>
            </div>
