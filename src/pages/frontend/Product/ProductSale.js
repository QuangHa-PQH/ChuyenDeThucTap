...
const ProductSale = () => {
  ...
  return (
        <section className="product_sale" style={{ backgroundColor: "#75c6fbff" }}>
            <div className="container">
              <div className="row">
                  ...
                  <div className="col-md-12 pb-5">
                    <h2 style={{ color: "#ffffff" }}><b>KHUYẾN MÃI</b></h2>
                  </div>
                          ...
                          <div className="card h-100 border-0 shadow-sm">
                            ...
                            <div className="card-body d-flex flex-column p-2">
                              ...
                              <div className="d-flex justify-content-between align-items-center mb-2">
                                <div>
                                    <p className="text-danger fw-bold mb-1 m-2">
                  ...
                  <Link to="/tat-ca-san-pham" className="btn btn-outline-warning">Xem tất cả sản phẩm</Link>
                  </div>
              </div>
            </div>
