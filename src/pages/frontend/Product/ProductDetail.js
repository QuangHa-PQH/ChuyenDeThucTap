    ...
    <div className="container py-5">
      ...
      <div className="row align-items-start">
        ...
        <div className="col-md-6">
          <h3>{product.name}</h3>
          <div className="mb-3">
            <span className="text-danger fs-4 fw-bold">{product.price.toLocaleString()}đ</span>
          </div>
          ...
          <div className="d-flex gap-3">
            ...
            <button className="btn btn-outline-success" onClick={handleAddToCart}>Thêm vào giỏ hàng</button>
          </div>
